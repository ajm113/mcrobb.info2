...
// module
exports.push([module.i, "._2y-dTE_emCjNAgTyz1Hbao input,._2y-dTE_emCjNAgTyz1Hbao textarea{border:none;border-bottom:1px solid gray;border-radius:2px;margin-bottom:10px;padding:4px;display:block;width:100%;background:#000;color:#fff}._2y-dTE_emCjNAgTyz1Hbao textarea{border-bottom:none;min-height:200px;max-width:100%;min-width:100%}", "", {"version":3,"sources":["/home/andrew/Documents/Projects/mcrobb.info2/src/components/contact/style.scss","/home/andrew/Documents/Projects/mcrobb.info2/src/style/_variables.scss"],"names":[],"mappings":"AAEA,iEAGQ,YAAY,AACZ,6BAAiD,AACjD,kBAAkB,AAClB,mBAAmB,AACnB,YAAY,AAEZ,cAAc,AACd,WAAW,AACX,gBCPS,ADQT,UCVS,CDWZ,AAbL,kCAgBQ,mBAAmB,AACnB,iBAAiB,AACjB,eAAe,AACf,cAAe,CAClB","file":"style.scss","sourcesContent":["@import \"~style/variables\";\n\n.myform {\n    input,\n    textarea {\n        border: none;\n        border-bottom: 1px solid darken($text-color, 50%);\n        border-radius: 2px;\n        margin-bottom: 10px;\n        padding: 4px;\n\n        display: block;\n        width: 100%;\n        background: $background;\n        color: $text-color;\n    }\n\n    textarea {\n        border-bottom: none;\n        min-height: 200px;\n        max-width: 100%;\n        min-width: 100%;\n    }\n}\n","@import url('https://fonts.googleapis.com/css?family=Montserrat');\n\n$montserrat-font: 'Montserrat', ariel, sans-serif;\n\n$text-color: #fff;\n$text-font: $montserrat-font;\n$background: #000;\n\n$screens-size-md: 768px;\n"],"sourceRoot":""}]);
...
//# sourceMappingURL=0-3a891ef91d5d3f71a037.min.js.map