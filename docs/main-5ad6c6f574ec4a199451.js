...
/******/ 	var hotCurrentHash = "5ad6c6f574ec4a199451"; // eslint-disable-line no-unused-vars
...
// module
exports.push([module.i, "*,:after,:before{box-sizing:border-box}html{font-size:100%;-webkit-text-size-adjust:100%;font-variant-ligatures:none;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale;font-smoothing:antialiased;text-shadow:rgba(0,0,0,.01) 0 0 1px}body{color:#000;background:#fff;font-family:Montserrat,ariel,sans-serif}h3{color:red}a{transition:color .5s;outline:none}a,a:visited{color:#000}a._25ENFXozQ7V6wlwzvE3qGS,a:hover{color:red}", "", {"version":3,"sources":["/home/andrew/Documents/Projects/mcrobb.info2/src/style/_common.scss","/home/andrew/Documents/Projects/mcrobb.info2/src/style/_variables.scss"],"names":[],"mappings":"AAAA,iBAEI,qBAAsB,CACzB,AAED,KAEI,eAAe,AACf,8BAA8B,AAE9B,4BAA4B,AAE5B,kCAAkC,AAClC,kCAAkC,AAClC,2BAA2B,AAC3B,mCAAuC,CAC1C,AAGD,KACE,WCZe,ADaf,gBCZe,ADaf,uCCpB+C,CDqBhD,AAED,GACI,SAAU,CACb,AAED,EAEE,qBAAuB,AACvB,YAAa,CAUd,AAbD,YACE,UCtBe,CD4Bd,AAPH,kCAWI,SAAU,CACX","file":"style.scss","sourcesContent":["*, ::after, ::before\n{\n    box-sizing: border-box;\n}\n\nhtml {\n    /* Adjust font size */\n    font-size: 100%;\n    -webkit-text-size-adjust: 100%;\n    /* Font varient */\n    font-variant-ligatures: none;\n    /* Smoothing */\n    text-rendering: optimizeLegibility;\n    -moz-osx-font-smoothing: grayscale;\n    font-smoothing: antialiased;\n    text-shadow: rgba(0, 0, 0, .01) 0 0 1px;\n}\n\n\nbody {\n  color: $text-color;\n  background: $background;\n  font-family: $text-font;\n}\n\nh3 {\n    color: red;\n}\n\na {\n  color: $text-color;\n  transition: color 500ms;\n  outline: none;\n\n  &:visited {\n    color: $text-color;\n  }\n\n  &.active,\n  &:hover {\n    color: red;\n  }\n}\n","@import url('https://fonts.googleapis.com/css?family=Montserrat');\n\n$montserrat-font: 'Montserrat', ariel, sans-serif;\n\n//$text-color: #fff;\n$text-font: $montserrat-font;\n//$background: #000;\n\n$text-color: #000;\n$background: #fff;\n\n$screens-size-md: 768px;\n"],"sourceRoot":""}]);
...
/******/ });
//# sourceMappingURL=main-5ad6c6f574ec4a199451.js.map