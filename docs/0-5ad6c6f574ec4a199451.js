...
// module
exports.push([module.i, "._2y-dTE_emCjNAgTyz1Hbao input,._2y-dTE_emCjNAgTyz1Hbao textarea{border:none;border-bottom:1px solid #000;border-radius:2px;margin-bottom:10px;padding:4px;display:block;width:100%;background:#fff;color:#000}._2y-dTE_emCjNAgTyz1Hbao textarea{border-bottom:none;min-height:200px;max-width:100%;min-width:100%}._2y-dTE_emCjNAgTyz1Hbao button{background:#fff;border:none;border-radius:5px;padding:5px;min-width:200px;color:#fff}", "", {"version":3,"sources":["/home/andrew/Documents/Projects/mcrobb.info2/src/components/contact/style.scss","/home/andrew/Documents/Projects/mcrobb.info2/src/style/_variables.scss"],"names":[],"mappings":"AAEA,iEAGQ,YAAY,AACZ,6BAAiD,AACjD,kBAAkB,AAClB,mBAAmB,AACnB,YAAY,AAEZ,cAAc,AACd,WAAW,AACX,gBCJS,ADKT,UCNS,CDOZ,AAbL,kCAgBQ,mBAAmB,AACnB,iBAAiB,AACjB,eAAe,AACf,cAAe,CAClB,AApBL,gCAuBQ,gBAAqC,AACrC,YAAY,AACZ,kBAAkB,AAClB,YAAY,AACZ,gBAAgB,AAChB,UAAW,CACd","file":"style.scss","sourcesContent":["@import \"~style/variables\";\n\n.myform {\n    input,\n    textarea {\n        border: none;\n        border-bottom: 1px solid darken($text-color, 50%);\n        border-radius: 2px;\n        margin-bottom: 10px;\n        padding: 4px;\n\n        display: block;\n        width: 100%;\n        background: $background;\n        color: $text-color;\n    }\n\n    textarea {\n        border-bottom: none;\n        min-height: 200px;\n        max-width: 100%;\n        min-width: 100%;\n    }\n\n    button {\n        background: lighten($background, 15%);\n        border: none;\n        border-radius: 5px;\n        padding: 5px;\n        min-width: 200px;\n        color: #fff;\n    }\n}\n","@import url('https://fonts.googleapis.com/css?family=Montserrat');\n\n$montserrat-font: 'Montserrat', ariel, sans-serif;\n\n//$text-color: #fff;\n$text-font: $montserrat-font;\n//$background: #000;\n\n$text-color: #000;\n$background: #fff;\n\n$screens-size-md: 768px;\n"],"sourceRoot":""}]);
...
//# sourceMappingURL=0-5ad6c6f574ec4a199451.js.map